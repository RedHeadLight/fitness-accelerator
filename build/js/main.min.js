...
var _faqTabbs = require("./modules/faq-tabbs");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _faqTabbs.initFaqTabbs)();
    (0, _reviewSlider.renderSlider)();
    (0, _video.initVideo)();
...
},{"./modules/accordion":2,"./modules/faq-tabbs":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/review-slider":13,"./modules/slider":14,"./modules/video":15,"./utils/ios-vh-fix":18,"./vendor/swiper":21}],2:[function(require,module,exports){
"use strict";
...
},{"../vendor/accordions":20}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tabs = exports.initFaqTabbs = void 0;
var _tabs = require("../vendor/tabs");
var tabs;
var initFaqTabbs = exports.initFaqTabbs = function initFaqTabbs() {
  exports.tabs = tabs = new _tabs.Tabs();
  window.tabs = tabs;
};

},{"../vendor/tabs":22}],4:[function(require,module,exports){
"use strict";
...
var renderSlider = exports.renderSlider = function renderSlider() {
  var swiperEl = document.querySelector('[data-review-swiper]');
  var buttonPrev = document.querySelector('[data-review-slider-btn-prev]');
  var buttonNext = document.querySelector('[data-review-slider-btn-next]');
...
var initSlider = exports.initSlider = function initSlider() {
  var swiperEl = document.querySelector('[data-swiper]');
  var buttonPrev = document.querySelector('[data-slider-btn-prev]');
  var buttonNext = document.querySelector('[data-slider-btn-next]');
...
var initVideo = exports.initVideo = function initVideo() {
  ...
  if (video) {
    var videoPlayBtn = video.querySelector('.video__play-button');
    videoPlayBtn.addEventListener('click', function (evt) {
      evt.preventDefault();
